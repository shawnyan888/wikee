...
class Options(object):
    def __init__(self):
        self.default_package = ["base", "jedi", "epic"]
    ...
    def run_option_parser(self):
        ...
        parser.add_argument("--package", choices=xData.PACKAGE_LOGOS.keys(), nargs="+", help="specify package list")
        ...
        self.package = filter(lambda x: x in opts.package, xData.PACKAGE_LOGOS.keys())
